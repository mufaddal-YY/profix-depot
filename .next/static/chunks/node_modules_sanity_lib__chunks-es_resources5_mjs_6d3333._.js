...
const structureLocaleStrings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sanity$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["defineLocalesResources"])("structure", {
    ...
    /** Description for the archived release banner, rendered when viewing the history of a version document from the publihed view */ "banners.archived-release.description": "You are viewing a read-only document that was archived as part of <VersionBadge> a release</VersionBadge>. It can't be edited",
    ...
    /** Description for the archived release banner, rendered when viewing the history of a version document from the publihed view */ "banners.published-release.description": "You are viewing a read-only document that was published as part of <VersionBadge> a release</VersionBadge>. It can't be edited",
    ...
    /** The text for the banner that appears when a document is not in the current global release */ "banners.release.not-in-release": "Not in the <Label>{{title}}</Label> release.",
